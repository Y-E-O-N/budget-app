...
class MarkdownExportService {
  ...
  String generateMarkdown({
    ...
    sb.writeln('| ${_col('budgetName')} | ${_col('budget')} | ${_col('used')} | ${_col('remaining')} | ${_col('usageRate')} |');
    sb.writeln('|------|------|------|------|--------|');
    ...
    for (var budget in budgets) {
      ...
      sb.writeln('| ${budget.name} | ${_formatAmount(budget.amount)} | ${_formatAmount(expense)} | ${_formatAmount(remaining)} | ${_calcPercent(expense, budget.amount)} |');
    }
    ...
    if (expenses.isNotEmpty) {
      ...
      sb.writeln('| ${_col('date')} | ${_col('budget')} | ${_col('subBudget')} | ${_col('memo')} | ${_col('amount')} |');
      sb.writeln('|------|------|------|------|------|');
      ...
      for (var exp in sortedExpenses) {
        ...
        sb.writeln('| ${dateFormat.format(exp.date)} | ${budget?.name ?? '-'} | ${subBudget?.name ?? '-'} | ${exp.memo ?? '-'} | ${_formatAmount(exp.amount)} |');
      }
      sb.writeln();
    }
